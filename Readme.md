...
## Problema ##
Se desea construir un programa que permita el manejo de correos electrónicos. El programa se desarrollará en un par de
iteraciones.
...
* El Cliente debe ser capaz de conectarse a un servidor de correos y enviar un correo a un usuario que tenga cuenta en
dicho servidor. En la primera versión el Cliente es simple. No necesita almacenar ni temporalmente ni localmente los
mensajes del usuario conectado.
* El Servidor debe ser capaz de responder a pedidos de conexión por parte de clientes y de entrega de correos
electrónicos. El Servidor también administra los correos de cada cliente.
